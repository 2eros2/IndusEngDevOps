...
export default function Tabla({ items, onClickDelete, onClickNuevo }) {
    return (
        <div className="card">
            <div className="card-body">
                <div className='row'>
                    <h5 className="card-title col-4 mt-1">Estadios:</h5>
                                        ...
                                        <tr key={index}>
                                            ...
                                            <td>
                                                <div className='row'>
                                                    ...
                                                    <button onClick={() => onClickDelete(item.IdEstadio)}
